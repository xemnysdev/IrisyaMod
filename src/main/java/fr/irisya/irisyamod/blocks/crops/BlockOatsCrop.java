...
public class BlockOatsCrop extends BlockBaseCrop implements IModelRegister
{
	private int tier;
	
	public BlockOatsCrop(String name, int tier)
	{
		super(name);
		this.tier = tier;
	}
