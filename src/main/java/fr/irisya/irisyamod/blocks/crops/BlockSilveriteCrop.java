...
public class BlockSilveriteCrop extends BlockBaseCrop implements IModelRegister
{
	private int tier;

	public BlockSilveriteCrop(String name, int tier)
	{
		super(name);
		this.tier = tier;
	}
	...
	{
		return ModItems.silverite_seed;
	}
	
	@Override
	protected Item getCrop() 
	{
		return ModItems.silver;
	}
