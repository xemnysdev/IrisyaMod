...
public class BlockRyeCrop extends BlockBaseCrop implements IModelRegister
{
	private int tier;
	
	public BlockRyeCrop(String name, int tier)
	{
		super(name);
		this.tier = tier;
	}
