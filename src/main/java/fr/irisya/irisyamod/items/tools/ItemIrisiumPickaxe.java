...
public class ItemIrisiumPickaxe extends ItemPickaxe implements IModelRegister 
{
	public ItemIrisiumPickaxe()
	{
		this(ToolMaterialIrisya.toolTypeIrisium, LibItemNames.IRISIUM_PICKAXE);
	}
	
	public ItemIrisiumPickaxe(ToolMaterial mat, String name) 
	{
		super(mat);
