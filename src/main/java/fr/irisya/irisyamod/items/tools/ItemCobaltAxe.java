...
public class ItemCobaltAxe extends ItemAxe implements IModelRegister
{
	public ItemCobaltAxe()
	{
		this(ToolMaterialIrisya.toolTypeCobalt, LibItemNames.COBALT_AXE);
	}
	
	public ItemCobaltAxe(ToolMaterial mat, String name) 
	{
		super(mat, 10.0F, -3.0F);
