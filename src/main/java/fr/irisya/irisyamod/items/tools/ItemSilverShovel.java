...
public class ItemSilverShovel extends ItemSpade implements IModelRegister 
{
	public ItemSilverShovel()
	{
		this(ToolMaterialIrisya.toolTypeSilver, LibItemNames.SILVER_SHOVEL);
	}
	
	public ItemSilverShovel(ToolMaterial mat, String name) 
	{
		super(mat);
