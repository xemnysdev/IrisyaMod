...
public class ItemCobaltPickaxe extends ItemPickaxe implements IModelRegister 
{
	public ItemCobaltPickaxe()
	{
		this(ToolMaterialIrisya.toolTypeCobalt, LibItemNames.COBALT_PICKAXE);
	}
	
	public ItemCobaltPickaxe(ToolMaterial mat, String name) 
	{
		super(mat);
