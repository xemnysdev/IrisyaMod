...
public class ItemIrisiumShovel extends ItemSpade implements IModelRegister
{
	public ItemIrisiumShovel()
	{
		this(ToolMaterialIrisya.toolTypeIrisium, LibItemNames.IRISIUM_SHOVEL);
	}
	
	public ItemIrisiumShovel(ToolMaterial mat, String name) 
	{
		super(mat);
