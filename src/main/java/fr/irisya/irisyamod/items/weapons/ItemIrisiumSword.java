...
public class ItemIrisiumSword extends ItemSword implements IModelRegister
{
	public ItemIrisiumSword()
	{
		this(ToolMaterialIrisya.toolTypeIrisium, LibItemNames.IRISIUM_SWORD);
	}
	
	public ItemIrisiumSword(ToolMaterial mat, String name) 
	{
		super(mat);
