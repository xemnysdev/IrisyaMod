...
public class ItemCobaltSword extends ItemSword implements IModelRegister
{
	public ItemCobaltSword()
	{
		this(ToolMaterialIrisya.toolTypeCobalt, LibItemNames.COBALT_SWORD);
	}
	
	public ItemCobaltSword(ToolMaterial mat, String name) 
	{
		super(mat);
