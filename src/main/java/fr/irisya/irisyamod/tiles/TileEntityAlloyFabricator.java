...
import fr.irisya.irisyamod.recipes.RecipesAlloyFabricator;
...
public class TileEntityAlloyFabricator extends TileEntityLockable implements ITickable 
{
	...
	{
		return hasCustomName() ? this.customName : "tile.alloy_fabricator";
	}
	...
	{
	    return RecipesAlloyFabricator.getRecipeResult(new ItemStack[] 
	    		{
